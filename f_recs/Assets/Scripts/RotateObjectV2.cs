...
public class RotateObjectV2 : MonoBehaviour
{
    ...
    public Camera camer;
    private GameObject centreOfRotation;
                ...
                switch (touch.phase)
                {
                    ...
                    case TouchPhase.Moved:
                        ...
                        if (Mathf.Abs(delta.x) > Mathf.Abs(delta.y))
                        {
                            ...
                            {
                                centreOfRotation.transform.Rotate(0, angle * RotationalSpeed, 0 , Space.Self);
                            }
                            else
                            {
                                centreOfRotation.transform.Rotate(0, -angle * RotationalSpeed, 0, Space.Self);
                        ...
                        {
                            centreOfRotation.transform.Rotate(0 , 0, angle * RotationalSpeed, Space.Self);
                        }
    ...
    public void SetStartPosition()
    {
        ...
        centreOfRotation.transform.position = new Vector3(13.5f, -7.629f, -18.29f);
        centreOfRotation.transform.rotation = Quaternion.Euler(0, 90, 0); 
    }
    ...
    void Update()
    {
        for (int i = 0; i < PathRootObject.transform.childCount; i++) {
            ...
            {
                floorList.Add(PathRootObject.transform.GetChild(i));
            }
        }
        ...
        centreOfRotation = Instantiate(new GameObject("centreOfRotation"));
        
        centreOfRotation.transform.position = centrePosition;

        Transform positionCentreOfRotation = centreOfRotation.GetComponent<Transform>();
        
        for (int i = 0; i < floorList.Count; i++)
        {
            floorList[i].SetParent(positionCentreOfRotation);
        }
